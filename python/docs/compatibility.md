...
| Existing OTel instrumentation | Confident/GenAI spans and their parents on shared TracerProvider; export_all_spans=True passes everything | Original IDs, parents, attributes, events and schema preserved; framework-specific coverage listed separately |
